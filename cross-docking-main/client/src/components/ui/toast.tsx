...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed z-[9999] flex flex-col gap-4 p-6 bottom-0 right-0 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg",
      className
    )}
    {...props}
  />
